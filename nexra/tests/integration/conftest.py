"""Shared fixtures for integration tests against real PostgreSQL (nexra_test).

Uses function-scoped engine + session with NullPool to avoid event loop
binding issues with asyncpg + pytest-asyncio.
"""
...
async def db_session() -> AsyncSession:
    ...
    Creates a new engine with NullPool per test to avoid event loop
